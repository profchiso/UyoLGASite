		...
		<div class="col-md-12">
			<div class="panel panel-primary">
				<!--<div class="panel-heading">
					...
					<a class="btn btn-danger btn-sm" data-toggle="modal" data-target="#candidateReg"><i class="fa fa-plus"></i> Add Student</a>
				</div>-->
							         ...
							         <?php
							         	if (isset($_POST['update'])) {
											...
											$password = $_POST['password'];
							         		$update_row = mysql_query("UPDATE voters SET Name = '$name',Sex='$sex' , School = '$school',Dept='$dept',Level='$level',Sch_Fees_reciept_No='$sch_fees_reciept_no',Hostel_Fees_reciept_NO='$hostel_fees_reciept_no',Password='$password' WHERE Regno = '$regno' ");
							         		if ($update_row) {
...
if(isset($_POST["register"])) {
	...
	$password = $_POST['password'];
		        ...
		        $sql = mysql_query("INSERT INTO voters(Regno,Name ,Sex,School,Dept,Level,Sch_Fees_reciept_No,Hostel_Fees_reciept_NO,Password)VALUES('$regno', '$name','$sex','$school','$dept','$level','$sch_Fees_reciept_no','$hostel_fees_reciept_no','$password')");
			        if ($sql) {
